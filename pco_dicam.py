...
class Camera:
    ...
    def __init__(self,
        ...
        self._set_intensifier_parameters(voltage=800, phosphor_us=10)
    ...
    def _set_intensifier_parameters(self, voltage, phosphor_us):
        ...
        Changes the intensifier voltage but keeps the current phosphor
        decay time. Safe values of voltage will vary by intensifier;
        these settings are for the 25 mm GaAsP GenIII intensifier.
        '''
        assert 500 <= voltage <= 800
    ...
    def apply_settings(
        ...
        voltage=None,       # intensifier voltage, 500 <= type(int) <= 800
...
def legalize_image_size(
    ...
    min_height, min_width, max_height, max_width = 16, 64, 2048, 2048
